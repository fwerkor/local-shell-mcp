...
| `allow_full_container` | `LOCAL_SHELL_MCP_ALLOW_FULL_CONTAINER` | `True` | 爲 true 時禁用工作區 / 路徑限制；只在一次性邊界內使用。 |
...
| `agent_dynamic_skill_tools` | `LOCAL_SHELL_MCP_AGENT_DYNAMIC_SKILL_TOOLS` | `False` | 是否啓用動態 skill 工具。 |
