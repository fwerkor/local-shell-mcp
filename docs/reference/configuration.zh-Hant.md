...
| `mcp_session_idle_timeout_s` | `LOCAL_SHELL_MCP_MCP_SESSION_IDLE_TIMEOUT_S` | `1800` | Stateful Streamable HTTP 會話空閒超時。 |
| `mcp_max_sessions` | `LOCAL_SHELL_MCP_MCP_MAX_SESSIONS` | `128` | Stateful MCP 會話最大併發數。 |
