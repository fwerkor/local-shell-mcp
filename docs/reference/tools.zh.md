...
`environment_get`、`skill_list`、`skill_load`、`skill_read`、`secret_scan`、`todo_read_tool`、`todo_write_tool`、`audit_tail`
...
`file_list`、`file_tree`、`file_glob`、`file_grep`、`file_read`、`file_write`、`file_edit`、`file_delete`、`file_patch`、`remote_transfer`
...
`remote_manage` (`invite`, `list`, `rename`, `revoke`)
