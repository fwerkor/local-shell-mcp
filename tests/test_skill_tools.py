...
from local_shell_mcp.skill_ops import list_installed_skills, load_installed_skill
    ...
    assert listed["skills"] == [
        {
            ...
            "description": "Diagnose failing tests safely.",
            "related_files": ["skills/debugging/checklist.md"],
        }
    ]
    assert loaded["name"] == "debugging"
    assert loaded["content"].startswith("---\ndescription:")
    assert loaded["related_files"] == ["skills/debugging/checklist.md"]
